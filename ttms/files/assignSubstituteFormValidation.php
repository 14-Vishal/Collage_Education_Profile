...
$periods = array("period1", "period2", "period3", "period4", "period5", "period6","practical");
...
<div class="content">
    <form method="post" id="smsform"><input type="hidden" name="uid" value="sender mobile number goes here"/>
        <input type="hidden" name="pwd" value="way2sms password goes here"/><input type="hidden" name="to" value="recipient mobile number goes here"/>
