...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">COLLEGE EDUCATION PROFILE</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/kle/KLE.jpg" alt="Chania">
        </div>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <div style="display:none" id="facultyForm">
			...
			<form action="studentFormValidation.php" method="POST" "overflow:hidden">
			<div class="form-group">
				<label for="studentno">Student No.</label>
				<input type="text" class="form-control" id="studentno" name="UN" placeholder="Student No...">
				</div>
			<div align="right">
				<input type="submit" class="btn btn-default" name="LOGIN" value="LOGIN">
    </div>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4> Said Anywhere</h4>
                <h4><strong>Call:</strong> 9702293839 </h4>
                <h4><strong>Email: </strong>vermac644@gmail.com</h4>
            </div>
