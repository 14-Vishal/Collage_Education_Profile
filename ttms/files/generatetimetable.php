...
<script>
    var assignSubstituteForm = document.getElementById("assignSubstituteForm");
    // Get the <span> element that closes the modal
    var modal = document.getElementById('myModal');
    var span = document.getElementsByClassName("close")[0];
    span.onclick = function () {
        modal.style.display = "none";
        assignSubstituteForm.style.display = "none";
    }
    ...
    <div align="center" style="margin-top: 30px">
        <select name="select_teacher" class="list-group-item">
            ...
            while ($row = mysqli_fetch_assoc($q)) {
                echo " \"<option value=\"{$row['faculty_number']}\">{$row['faculty_name']}</option>\"";
            }
            ?>
        ...
        <table border="2" cellspacing="3" align="center" id="timetable">
            ...
            <tr>
                ...
                <td style=\"text-align:center\">{$row['practical']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA COLLEGE EDUCATION PROFILE, INFORMATION TECHNOLOGY DEPARTMENT";
                    echo "<div style='margin-left: 10px' align='center'><p><font color=white>" . "<br>" . $str . "</font></p><br></div>" .
                        "<div style='margin-left: 10px' align='center'><p><font color=white>" .  $sign . "</font></p><br></div>";
                }
                if (isset($_POST['select_teacher'])) {
